package biblionetTest.evolution.autenticazione.controller;
...
/**
    ...
    public void modificaLettoreCorretto(
        ...
        when(lettoreDAO.findByEmail(lettore.getEmail())).thenReturn(lettore);
    ...
    public void modificaLettoreErrato1(
        ...
        when(lettoreDAO.findByEmail(lettore.getEmail())).
                thenReturn(lettore);
    ...
    public void modificaEsperto(
        ...
        when(espertoDAO.findByEmail(esperto.getEmail())).thenReturn(esperto);

        when(bibliotecaDAO
                .findByEmail(esperto.getBiblioteca().getEmail()))
                .thenReturn((Biblioteca) esperto.getBiblioteca());
    ...
    public void modificaEspertoErrato1(
        ...
        when(espertoDAO.findByEmail(esperto.getEmail())).
                thenReturn(esperto);
    ...
    public void modificaBiblioteca(
        ...
        when(bibliotecaDAO.findByEmail(biblioteca.getEmail())).
