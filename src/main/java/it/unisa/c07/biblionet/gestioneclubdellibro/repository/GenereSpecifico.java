...
import static it.unisa.c07.biblionet.gestioneclubdellibro.repository.GenereSpecifico.genereDescrizioneMap;

@Entity
@Data
@Getter
@Setter
public final class GenereSpecifico {
    public static Map<GenereS, String> genereDescrizioneMap;
    @Id
    private Long id;

    public GenereSpecifico() {
    ...
    public static String getDescrizioneByGenere(String genere) {
